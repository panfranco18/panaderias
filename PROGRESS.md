...
- [x] **Horarios del personal, reporte manual de faltantes y permiso por categoría** — pedido del usuario 2026-08-04 ("que al superadmin le avise quiénes están trabajando en qué horario... que el cajero o encargado pueda poner qué faltante de stock tiene... en qué categorías pueden los empleados reportar faltantes"). Migración `supabase/011_horarios_y_faltantes.sql`.
  ...
  - ~~Pendiente: falta que el usuario corra `supabase/011_horarios_y_faltantes.sql`~~ — corrida y probada 2026-08-04 en producción: cargué un turno de prueba (Yasmin, Felice 45, 09:00 a 17:00) y apareció agrupado por día en Horarios; desde Caja reporté un faltante de "Panes" y la notificación le llegó al superadmin ("Faltante reportado en 13 de Caballería (Dueno) — Panes: ..."). Datos de prueba borrados al terminar.
